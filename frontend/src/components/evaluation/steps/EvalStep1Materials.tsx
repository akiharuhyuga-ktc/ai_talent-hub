	...
	return (
		<div>
			...
			<p className="text-xl text-gray-500 mb-8">
				自動収集されたデータを確認し、自己評価とマネージャー補足を入力してください。
			</p>
						...
						<div>
							<p className="text-lg text-gray-600 mb-2">
								...
								<span className="font-semibold">
									{context.oneOnOneRecords.length}件
								</span>
							</p>
							{latestCondition && (
								<div>
									...
									<div className="flex flex-wrap gap-3">
										{latestCondition.map((s) => (
											<span
												key={s.label}
												className="text-lg bg-white border border-gray-200 rounded-lg px-4 py-2"
											>
												{s.label}：
			...
			<div className="mb-10">
				...
				<p className="text-lg text-gray-400 mb-4">
					カオナビの自己評価を参照して入力してください
				</p>

				<div className="space-y-5">
					<div>
						<label
							htmlFor="self-eval-score"
						...
						<select
							...
							onChange={(e) =>
								setSelfEval({
									...selfEval,
									score: e.target.value as EvaluationGrade | "",
								})
							}
					...
					<div>
						<label
							htmlFor="self-eval-achievement"
							className="block text-xl font-medium text-gray-700 mb-2"
						>
							達成状況コメント <span className="text-red-500">*</span>
						</label>
						<textarea
							id="self-eval-achievement"
							value={selfEval.achievementComment}
							onChange={(e) =>
								setSelfEval({
									...selfEval,
									achievementComment: e.target.value,
								})
							}
							rows={6}
					...
					<div>
						<label
							htmlFor="self-eval-reflection"
							className="block text-xl font-medium text-gray-700 mb-2"
						>
							振り返りコメント <span className="text-red-500">*</span>
						</label>
						<textarea
							id="self-eval-reflection"
							value={selfEval.reflectionComment}
							onChange={(e) =>
								setSelfEval({
									...selfEval,
									reflectionComment: e.target.value,
								})
							}
							rows={6}
			...
			<div className="mb-10">
				...
				<div className="space-y-5">
					<div>
						<label
							htmlFor="supplement-episodes"
							className="block text-xl font-medium text-gray-700 mb-2"
						>
							特筆すべきエピソード
						</label>
						<textarea
							id="supplement-episodes"
							value={supplement.notableEpisodes}
							onChange={(e) =>
								setSupplement({
									...supplement,
									notableEpisodes: e.target.value,
								})
							}
							rows={5}
					...
					<div>
						<label
							htmlFor="supplement-env-changes"
							className="block text-xl font-medium text-gray-700 mb-2"
						>
							環境変化・特殊事情
						</label>
