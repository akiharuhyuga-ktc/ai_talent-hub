...
export function Step4PreviousPeriod({
	initial,
	onNext,
	onSkip,
	onBack,
		...
		<div>
			...
			<div className="space-y-6 mb-10">
				<div>
					...
					<textarea
						...
						onChange={(e) =>
							setForm({ ...form, previousGoals: e.target.value })
						}
						rows={5}
				...
				<div>
					...
					<select
						...
						onChange={(e) =>
							setForm({
								...form,
								achievementLevel: e.target
									.value as PreviousPeriod["achievementLevel"],
							})
						}
				...
				{form.achievementLevel === "not-achieved" && (
					<div>
						<label
							htmlFor="reasonIfNotAchieved"
							className="block text-xl font-medium text-gray-700 mb-2"
						>
							未達の理由
						</label>
						<textarea
							id="reasonIfNotAchieved"
							value={form.reasonIfNotAchieved}
							onChange={(e) =>
								setForm({
									...form,
									reasonIfNotAchieved: e.target.value,
								})
							}
							rows={2}
			...
			<div className="flex justify-end gap-4">
				...
				<button
					type="button"
					onClick={onSkip}
					className="px-8 py-3.5 text-xl border border-gray-200 text-gray-500 rounded-xl font-medium hover:bg-gray-50 transition-colors"
				>
					スキップ
				</button>
				<button
