...
export function OOStep1ActionReview({
	actionReviews,
	isFirstTime,
	priorityMessage,
	onNext,
	...
	const allStatusSelected =
		reviews.length === 0 || reviews.every((r) => r.status !== "");
					...
					>
						<div className="mb-4">
							...
							<span className="text-lg text-gray-500">
								担当：{ASSIGNEE_LABEL[review.assignee] || review.assignee}
							</span>
						</div>
