...
function getCompletionRate(
	...
	const completed = arrivedMonths.filter((mk) =>
		member.oneOnOneMonths.includes(mk),
	).length;
	return { completed, total };
}

export function TeamMatrixTable({
	members,
	period,
	today,
					...
					{members.length === 0 && (
						<tr>
							<td
								...
								className="px-5 py-10 text-center text-lg text-gray-400"
							>
								該当するメンバーがいません
							</td>
						</tr>
