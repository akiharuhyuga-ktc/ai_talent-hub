...
export function PolicyStep3BUpperPolicy({ onNext, onBack }: PolicyStep3BUpperPolicyProps) {
      ...
      <div className="space-y-6">
        <div>
          <label className="block text-xl font-medium text-gray-700 mb-2">
            上位組織の方針 <span className="text-lg text-gray-400 font-normal ml-2">（任意）</span>
          </label>
